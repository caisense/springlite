...
import com.handa.springlite.context.AnnotationConfigApplicationContext;
import com.handa.springlite.io.PropertyResolver;
import com.handa.springlite.web.controller.ControllerConfiguration;
import com.handa.springlite.web.controller.ApiController.SigninObj;
...
public class DispatcherServletTest {
    ...
    void getProduct() throws ServletException, IOException {
        ...
        assertTrue(resp.getContentAsString().contains("<a href=\"/product/123\">SpringLite Software</a>"));
    }
    ...
    PropertyResolver createPropertyResolver() {
        ...
        ps.put("springlite.web.favicon-path", "/icon/favicon.ico");
        ps.put("springlite.web.freemarker.template-path", "/WEB-INF/templates");
