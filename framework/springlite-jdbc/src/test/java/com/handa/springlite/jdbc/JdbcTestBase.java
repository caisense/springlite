...
public class JdbcTestBase {
    ...
    public PropertyResolver createPropertyResolver() {
        ...
        ps.put("springlite.datasource.url", "jdbc:sqlite:test.db");
        ps.put("springlite.datasource.username", "sa");
        ps.put("springlite.datasource.password", "");
        ps.put("springlite.datasource.driver-class-name", "org.sqlite.JDBC");
