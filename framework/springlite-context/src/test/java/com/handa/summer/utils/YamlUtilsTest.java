package com.handa.springlite.utils;
...
public class YamlUtilsTest {
    ...
    public void testLoadYaml() {
        ...
        assertEquals("SpringLite Framework", configs.get("app.title"));
        assertEquals("1.0.0", configs.get("app.version"));
        assertNull(configs.get("app.author"));

        assertEquals("${AUTO_COMMIT:false}", configs.get("springlite.datasource.auto-commit"));
