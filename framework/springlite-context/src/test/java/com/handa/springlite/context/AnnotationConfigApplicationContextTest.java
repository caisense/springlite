package com.handa.springlite.context;
...
import com.handa.scan.ScanApplication;
import com.handa.scan.convert.ValueConverterBean;
import com.handa.scan.custom.annotation.CustomAnnotationBean;
import com.handa.scan.destroy.AnnotationDestroyBean;
import com.handa.scan.destroy.SpecifyDestroyBean;
import com.handa.scan.init.AnnotationInitBean;
import com.handa.scan.init.SpecifyInitBean;
import com.handa.scan.nested.OuterBean;
import com.handa.scan.nested.OuterBean.NestedBean;
import com.handa.scan.primary.DogBean;
import com.handa.scan.primary.PersonBean;
import com.handa.scan.primary.TeacherBean;
import com.handa.scan.proxy.InjectProxyOnConstructorBean;
import com.handa.scan.proxy.InjectProxyOnPropertyBean;
import com.handa.scan.proxy.OriginBean;
import com.handa.scan.proxy.SecondProxyBean;
import com.handa.scan.sub1.Sub1Bean;
import com.handa.scan.sub1.sub2.Sub2Bean;
import com.handa.scan.sub1.sub2.sub3.Sub3Bean;
